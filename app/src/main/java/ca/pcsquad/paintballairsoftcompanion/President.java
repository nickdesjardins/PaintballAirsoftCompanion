...
public class President extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setImageResource(R.drawable.label_gm_president);
        btnBack.setOnClickListener(imgButtonHandler);

        FillPage fill = new FillPage();
        fill.Desc("Rebels vs. Special Force. The rebels have kidnapped the president. The rebels need to bring the president from one side of the map to the other without letting the president run away or get shot. The Special Force team needs to bring the president at the designated safe area. If the president gets shot everybody loses.");
        fill.Goals("Rebels: Bring the president to their base.\n" +
                "Special Force: Retrieve the president and bring him to the safe area.");
