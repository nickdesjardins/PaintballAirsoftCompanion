...
public class SupplyCrate extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setImageResource(R.drawable.label_gm_supply_crate);
        btnBack.setOnClickListener(imgButtonHandler);

        FillPage fill = new FillPage();
        fill.Desc("Each team starts at either side of the field. Both teams fight to take the supply crate from the middle of the map and bring it to their base.");
        fill.Goals("Bring the supply crate to your base.");
        fill.Respawn("Respawn allowed.");
        fill.Team("2 Teams");
        fill.Players("8 Players");
        fill.Items("A crate big enough to be transported by 2 teammates.\n" +
                "* If you don't have a crate, a big log will work.");
        ...
        imgLoader.displayImage("drawable://" + R.drawable.rules_players_8, rule3);

        rule4 = (ImageView) findViewById(R.id.imgrule4);
        imgLoader.displayImage("drawable://" + R.drawable.rules_item_ammo, rule4);
